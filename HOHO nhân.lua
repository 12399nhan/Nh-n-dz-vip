...
if not isSupport then
	loadstring(game:HttpGet('https://raw.githubusercontent.com/acsu123/Nhân Dz Hub V2/refs/heads/main/ScriptLoadButOlder.lua'))()
	wait(9e9)
end
...
do	
	Nhân Dz Hub _Passcheck = Instance.new("ScreenGui")
	...
	Nhân Dz Hub _Passcheck.IgnoreGuiInset = true
	Nhân Dz Hub _Passcheck.ResetOnSpawn = false
	Nhân Dz Hub _Passcheck.Name = "Hоhо_раssсhесk"
	Nhân Dz Hub _Passcheck.ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
	Nhân Dz Hub _Passcheck.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    CoreGuiAdd(Nhân Dz Hub _Passcheck)
	Nhân Dz Hub _Passcheck.Enabled = true
	...
	INTRO.Parent = Nhân Dz Hub _Passcheck
	...
	GET_KEY.Parent = Nhân Dz Hub _Passcheck
	...
	Nhân Dz Hub _Gen4 = Instance.new("ScreenGui")
	...
	Nhân Dz Hub _Gen4.IgnoreGuiInset = true
	Nhân Dz Hub _Gen4.Enabled = true
	Nhân Dz Hub _Gen4.ResetOnSpawn = false
	Nhân Dz Hub _Gen4.Name = "Hоhо_gеn4"
	Nhân Dz Hub _Gen4.ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
	Nhân Dz Hub _Gen4.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    CoreGuiAdd(Nhân Dz Hub _Gen4)
	...
	NOTIFICATION_ZONE.Parent = Nhân Dz Hub _Gen4
    ...
    if (isfile("Nhân Dz Hub _Intro.txt") and (tick() - tonumber(readfile("Nhân Dz Hub _Intro.txt"))) >= 86400) or not isfile("Nhân Dz Hub _Intro.txt") then
        writefile("Nhân Dz Hub _Intro.txt", tostring(tick())) 
        
        local preload_content = {}
        for i,v in pairs(Nhân Dz Hub _Passcheck:GetDescendants()) do
	...
	local do_check_key = function(key)
		...
		StarterGui:SetCore("SendNotification",{
			...
			Icon = "rbxassetid://127536002839129"
		})
		...
		if (status.code == "KEY_VALID") then			
			...
			Debris:AddItem(Nhân Dz Hub _Passcheck,.25)
			Debris:AddItem(Nhân Dz Hub _Gen4,.25)

			writefile("Nhân Dz Hub KeyV4.txt", key)
	...
	Get.MouseButton1Click:Connect(function()
        setclipboard('https://Nhân Dz Hub comunity.xyz/api/getkeyv4?hwid=' .. tick())
        StarterGui:SetCore("SendNotification",{
            Title = "Key System",
	...
	do
		if isfile("Nhân Dz Hub KeyV4.txt") or _G.MY_KEY_IS then
			local key = _G.MY_KEY_IS and _G.MY_KEY_IS or readfile("Nhân Dz Hub KeyV4.txt")
