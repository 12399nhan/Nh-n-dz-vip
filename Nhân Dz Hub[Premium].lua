shared.LoaderTitle = "Nhân Dz Hub V4";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://127536002839129",
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua"))();
local v15 = v14:CreateWindow({
    Title = "Nhân Dz Hub v5",
    SubTitle = "[Premium] nhân quang minh",
    TabWidth = 160,
    Theme = "Dark blue",
    Acrylic = false,
...
local v16 = {
    ...
    Sea = v15:AddTab({
        Title = "Sự Kiện(kitsune,sea,draco,...)"
    }),
    ITM = v15:AddTab({
        Title = "Vật Phẩm"
    }),
...
v16.Home:AddButton({
    Title = "Kênh Tiktok bố nhân đây",
    Description = "Tại Đây",
    Callback = function()
        setclipboard("https://www.tiktok.com/@boy27th5?_t=ZS-8tpPdIC2bNo&_r=1");
    end
});
...
local v48 = v16.Main:AddDropdown("DropdownSelectWeapon", {
    Title = "Vũ Khí",
    Description = "Chọn vũ khí để thăm ngàn nha cu",
    Values = {
        "Melee",
        "Sword",
        "Blox Fruits"
